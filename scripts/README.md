# EDRDG Dictionary Archive Scripts

Dictionary file versions are archived in this repo as sequences of patches.
The scripts in this folder allow for files to be easily rebuilt
from those patches and for new patches to be written to the archive.
